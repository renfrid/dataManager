...
<div id="navbar">
    <div class="container_12">
        <ul class="sf-menu">
            ...
            <li><a href="<?php echo site_url('ohkr/disease_list'); ?>">OHKR</a></li>
            <li><a href="<?php echo site_url('feedback/feedback_list'); ?>">Feedback</a></li>
            <li><a href="<?php echo site_url('campaign/campaign_list'); ?>">Campaign</a></li>
